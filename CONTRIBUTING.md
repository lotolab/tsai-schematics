...
**Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests.** You've got much better chances of getting your question answered on 
...
You can file new issues by filling out our [new issue form](https://github.com/lotolab/tsai-schematics/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/lotolab/tsai-schematics/pulls) for an open or closed PR
...
Samples: (even more [samples](https://github.com/lotolab/tsai-plat/commits/main))
